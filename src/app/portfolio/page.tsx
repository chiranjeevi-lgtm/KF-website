...
export default function PortfolioPage() {
  return (
    <>
      {/* HERO BANNER */}
      <section className="relative flex h-[55vh] md:h-[90vh] min-h-[280px] md:min-h-[600px] items-center justify-center bg-dark">
        <div className="absolute inset-0 bg-black/50" />
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="font-heading text-3xl md:text-5xl lg:text-7xl uppercase mb-3 md:mb-4">
            Our Portfolio
          </h1>
